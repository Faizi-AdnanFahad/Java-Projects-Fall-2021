...
public class Tests {
	...
	@Test
	public void test_weather_station_06() { // 
		WeatherStation station1 = new WeatherStation("Station@NorthYork", 50);
		WeatherStation station2 = new WeatherStation("Station@Markham", 60);
		...
		WeatherApp app1 = new SensorApp("Sensor1234", 20);
		WeatherApp app2 = new ForecastApp("Forecaster5678", 60); 
		WeatherApp app3 = new ForecastApp("Forecaster6678", 60); 
		WeatherApp app4 = new ForecastApp("Forecaster7678", 60); 
		WeatherApp app5 = new ForecastApp("Forecaster8678", 60); 

		
		station1.connect(app2);
		assertEquals("Station@NorthYork is connected by 1 apps: <Weather Forecast App Forecaster5678>.", station1.toString());
		assertEquals("Weather Forecast App Forecaster5678 is connected to 1 stations: <Station@NorthYork>.", app2.toString());
		
		
		station1.connect(app3);
		assertEquals("Station@NorthYork is connected by 2 apps: <Weather Forecast App Forecaster5678, Weather Forecast App Forecaster6678>.", station1.toString());
		assertEquals("Weather Forecast App Forecaster6678 is connected to 1 stations: <Station@NorthYork>.", app3.toString());
		
		station1.connect(app4);
		assertEquals("Station@NorthYork is connected by 3 apps: <Weather Forecast App Forecaster5678, Weather Forecast App Forecaster6678, Weather Forecast App Forecaster7678>.", station1.toString());
		assertEquals("Weather Forecast App Forecaster7678 is connected to 1 stations: <Station@NorthYork>.", app4.toString());
		
		station1.connect(app5);
		assertEquals("Station@NorthYork is connected by 4 apps: <Weather Forecast App Forecaster5678, Weather Forecast App Forecaster6678, Weather Forecast App Forecaster7678, Weather Forecast App Forecaster8678>.", station1.toString());
		assertEquals("Weather Forecast App Forecaster8678 is connected to 1 stations: <Station@NorthYork>.", app5.toString());
